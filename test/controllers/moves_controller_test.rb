...
class MovesControllerTest < ActionController::TestCase
  ...
  test "should create move" do
    assert_difference('Move.count') do
      post :create, move: { orientation: @move.orientation, robot_id: @move.robot_id, xcoordinate: @move.xcoordinate, xcoordinate: @move.xcoordinate }
    end
  ...
  test "should update move" do
    patch :update, id: @move, move: { orientation: @move.orientation, robot_id: @move.robot_id, xcoordinate: @move.xcoordinate, xcoordinate: @move.xcoordinate }
    assert_redirected_to move_path(assigns(:move))
  end
